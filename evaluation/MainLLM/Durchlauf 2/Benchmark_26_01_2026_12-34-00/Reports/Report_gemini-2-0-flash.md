...
## 1. Project Overview
- **Description:** This project is likely designed to onboard new repositories into a system, possibly automating the process of analyzing and documenting code. It uses a combination of tools, including AST parsing, relationship analysis, and LLMs, to extract information from a repository and generate reports.
- **Key Features:** 
  - Automated code analysis
  - Dependency graph construction
  - LLM-based documentation generation
  - Token usage evaluation
- **Tech Stack:** Python, Langchain, NetworkX, Streamlit, Google Gemini, OpenAI, Ollama, Pydantic, TOON format

*   **Repository Structure:**
```mermaid
graph LR
root --> directory[[SystemPrompts<br/>backend<br/>database<br/>frontend<br/>notizen<br/>result<br/>schemas<br/>statistics]]
...
- **node** (`ast.Import`): The AST node representing an import statement.
        *   *Returns:* 
        *   **Usage:** From `backend.AST_Schema.ASTVisitor.visit_Import` and ``
    *   **`visit_ImportFrom`**
...
- **node** (`ast.ImportFrom`): The AST node representing a 'from ... import ...' statement.
        *   *Returns:* 
        *   **Usage:** From `backend.AST_Schema.ASTVisitor.visit_ImportFrom` and ``
    *   **`visit_ClassDef`**
...
- **node** (`ast.ClassDef`): The AST node representing a class definition.
        *   *Returns:* 
        *   **Usage:** From `backend.AST_Schema.ASTVisitor.visit_ClassDef` and ``
    *   **`visit_FunctionDef`**
...
- **node** (`ast.FunctionDef`): The AST node representing a function definition.
        *   *Returns:* 
        *   **Usage:** From `backend.AST_Schema.ASTVisitor.visit_FunctionDef` and ``
...
- **node** (`ast.AsyncFunctionDef`): The AST node representing an asynchronous function definition.
        *   *Returns:* 
        *   **Usage:** From `backend.AST_Schema.ASTVisitor.visit_AsyncFunctionDef` and ``
...
- **full_schema** (`dict`): The updated 'full_schema' dictionary with integrated relationship data.
        *   **Usage:** From `backend.AST_Schema.ASTAnalyzer.merge_relationship_data` and ``
    *   **`analyze_repository`**
...
- **full_schema** (`dict`): A dictionary representing the AST schema of the analyzed repository, structured by file paths.
        *   **Usage:** From `backend.AST_Schema.ASTAnalyzer.analyze_repository` and ``
...
- **resolved** (`list[str]`): A list of resolved module or symbol names as strings.
        *   **Usage:** From `backend.File_Dependency.FileDependencyGraph._resolve_module_name` and ``
    *   **`visit_Import`**
...
- **base_name** (`str | None`): An optional base name for the module, typically used for from ... import ... statements where the module part is resolved separately.
        *   *Returns:* 
        *   **Usage:** From `backend.File_Dependency.FileDependencyGraph.visit_Import` and ``
    *   **`visit_ImportFrom`**
...
- **node** (`ImportFrom`): The AST ImportFrom node to be processed.
        *   *Returns:* 
        *   **Usage:** From `backend.File_Dependency.FileDependencyGraph.visit_ImportFrom` and ``
