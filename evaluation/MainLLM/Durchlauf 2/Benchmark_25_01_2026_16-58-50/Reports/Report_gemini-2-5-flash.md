...
-   **Description:** The Repo Onboarding Agent is an intelligent system designed to automate the generation of comprehensive documentation for software repositories. It leverages Large Language Models (LLMs) to analyze code structure, dependencies, and functional aspects, and provides a web-based interface for user interaction and persistent storage of documentation and chat exchanges.
-   **Key Features:**
    -   Automated Git repository cloning and content processing.
    -   Structured code analysis (Abstract Syntax Tree, dependencies, call graphs).
    -   LLM-powered generation of function, method, and class documentation.
    -   Interactive web-based interface for user queries and documentation viewing (Streamlit).
    -   Persistent storage for user API keys, chat history, and generated reports (MongoDB).
-   **Tech Stack:** `streamlit`, `langchain`, `google-ai-generativelanguage`, `ollama`, `openai`, `GitPython`, `pymongo`, `pydantic`, `cryptography`, `altair`, `nbformat`.

*   **Repository Structure:**
    ```mermaid
    graph TD
        root_node["root<br/>.env.example<br/>.gitignore<br/>analysis_output.json<br/>output.json<br/>output.toon<br/>readme.md<br/>requirements.txt<br/>test.json"]
        root_node --> root_node_SystemPrompts
        root_node --> root_node_backend
        root_node --> root_node_database
        root_node --> root_node_frontend
        root_node --> root_node_notizen
        root_node --> root_node_result
        root_node --> root_node_schemas
        root_node --> root_node_statistics
        root_node_SystemPrompts["SystemPrompts<br/>SystemPromptClassHelperLLM.txt<br/>SystemPromptFunctionHelperLLM.txt<br/>SystemPromptHelperLLM.txt<br/>SystemPromptMainLLM.txt<br/>SystemPromptMainLLMToon.txt<br/>SystemPromptNotebookLLM.txt"]
        root_node_backend["backend<br/>AST_Schema.py<br/>File_Dependency.py<br/>HelperLLM.py<br/>MainLLM.py<br/>__init__.py<br/>basic_info.py<br/>callgraph.py<br/>converter.py<br/>getRepo.py<br/>main.py<br/>relationship_analyzer.py<br/>scads_key_test.py"]
        root_node_database["database<br/>db.py"]
        root_node_frontend["frontend<br/>__init__.py<br/>frontend.py"]
        root_node_frontend --> root_node_frontend__streamlit
        root_node_frontend --> root_node_frontend_gifs
        root_node_frontend__streamlit["config.toml"]
        root_node_frontend_gifs["4j.gif"]
        root_node_notizen["notizen<br/>Report Agenda.txt<br/>Zwischenpraesentation Agenda.txt<br/>doc_bestandteile.md<br/>notizen.md<br/>paul_notizen.md<br/>praesentation_notizen.md<br/>technische_notizen.md"]
        root_node_notizen --> root_node_notizen_grafiken
        root_node_notizen_grafiken["grafiken"]
        root_node_notizen_grafiken --> root_node_notizen_grafiken_1
        root_node_notizen_grafiken --> root_node_notizen_grafiken_2
        root_node_notizen_grafiken --> root_node_notizen_grafiken_Flask_Repo
        root_node_notizen_grafiken --> root_node_notizen_grafiken_Repo_onboarding
        root_node_notizen_grafiken_1["1<br/>File_Dependency_Graph_Repo.dot<br/>global_callgraph.png<br/>global_graph.png<br/>global_graph_2.png<br/>repo.dot"]
        root_node_notizen_grafiken_2["2<br/>FDG_repo.dot<br/>fdg_graph.png<br/>fdg_graph_2.png<br/>filtered_callgraph_flask.png<br/>filtered_callgraph_repo-agent.png<br/>filtered_callgraph_repo-agent_3.png<br/>filtered_repo_callgraph_flask.dot<br/>filtered_repo_callgraph_repo-agent-3.dot<br/>filtered_repo_callgraph_repo-agent.dot<br/>global_callgraph.png<br/>graph_flask.md<br/>repo.dot"]
        root_node_notizen_grafiken_Flask_Repo["Flask-Repo<br/>__init__.dot<br/>__main__.dot<br/>app.dot<br/>auth.dot<br/>blog.dot<br/>blueprints.dot<br/>cli.dot<br/>conf.dot<br/>config.dot<br/>conftest.dot<br/>ctx.dot<br/>db.dot<br/>debughelpers.dot<br/>factory.dot<br/>flask.dot<br/>globals.dot<br/>hello.dot<br/>helpers.dot<br/>importerrorapp.dot<br/>logging.dot<br/>make_celery.dot<br/>multiapp.dot<br/>provider.dot<br/>scaffold.dot<br/>sessions.dot<br/>signals.dot<br/>tag.dot<br/>tasks.dot<br/>templating.dot<br/>test_appctx.dot<br/>test_async.dot<br/>test_auth.dot<br/>test_basic.dot<br/>test_blog.dot<br/>test_blueprints.dot<br/>test_cli.dot<br/>test_config.dot<br/>test_config.png<br/>test_converters.dot<br/>test_db.dot<br/>test_factory.dot<br/>test_helpers.dot<br/>test_instance_config.dot<br/>test_js_example.dot<br/>test_json.dot<br/>test_json_tag.dot<br/>test_logging.dot<br/>test_regression.dot<br/>test_reqctx.dot<br/>test_request.dot<br/>test_session_interface.dot<br/>test_signals.dot<br/>test_subclassing.dot<br/>test_templating.dot<br/>test_testing.dot<br/>test_user_error_handler.dot<br/>test_views.dot<br/>testing.dot<br/>typing.dot<br/>typing_app_decorators.dot<br/>typing_error_handler.dot<br/>typing_route.dot<br/>views.dot<br/>wrappers.dot<br/>wsgi.dot"]
        root_node_notizen_grafiken_Repo_onboarding["Repo-onboarding<br/>AST.dot<br/>Frontend.dot<br/>HelperLLM.dot<br/>HelperLLM.png<br/>MainLLM.dot<br/>agent.dot<br/>basic_info.dot<br/>callgraph.dot<br/>getRepo.dot<br/>graph_AST.png<br/>graph_AST2.png<br/>graph_AST3.png<br/>main.dot<br/>tools.dot<br/>types.dot"]
        root_node_result["result<br/>ast_schema_01_12_2025_11-49-24.json<br/>notebook_report_23_12_2025_12-56-24_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-06-09_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-09-29_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-26-34_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-33-06_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_29_12_2025_15-03-21_NotebookLLM_gemini-2.5-flash.md<br/>report_01_12_2025_12-26-46_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_12-55-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_13-37-30_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-15-04_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-42-38_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_22-46-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.md<br/>report_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.md<br/>report_14_11_2025_14-52-36.md<br/>report_14_11_2025_15-21-53.md<br/>report_14_11_2025_15-26-24.md<br/>report_21_11_2025_15-43-30.md<br/>report_21_11_2025_16-06-12.md<br/>report_22_11_2025_14-01-50_Helper_llama3_Main_geminipro.md<br/>report_22_11_2025_14-39-55_Helper_llama3_MainLLM_llama3.md<br/>result_2025-11-11_12-30-53.md<br/>result_2025-11-11_12-43-51.md<br/>result_2025-11-11_12-45-37.md"]
        root_node_schemas["schemas<br/>types.py"]
        root_node_statistics["statistics<br/>savings_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.png<br/>savings_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.png<br/>savings_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.png<br/>savings_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.png<br/>savings_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.png"]
    ```
...
### Setup Guide
Could not be determined due to missing information.

### Quick Startup
Could not be determined due to missing information.

## 3. Use Cases & Commands
The Repo Onboarding Agent is primarily designed to facilitate comprehensive code understanding and documentation for software projects. Key use cases and inferred operational commands include:

*   **Automated Documentation Generation**: Users can provide a Git repository URL (e.g., `https://github.com/owner/repo.git`) to automatically generate a detailed Markdown report. This report includes summaries of functions, classes, methods, their parameters, return values, and usage contexts, powered by Large Language Models.
*   **Interactive Code Analysis**: Through a Streamlit web interface, users can interactively explore the generated documentation. This might involve:
    *   Querying specific code components for their purpose or implementation details.
    *   Navigating through code structures and dependencies visualized in the reports.
*   **Repository Insight**: The system provides deep insights into a repository's internal structure, including:
    *   File dependencies.
    *   Call graphs between functions and methods.
    *   Abstract Syntax Tree (AST) representations.
*   **Personalized LLM Configuration**: Users can manage their API keys for various Large Language Models (e.g., Google Gemini, OpenAI, Ollama, or custom SCADSLLM endpoints) to tailor the documentation generation process. This allows for flexibility in model choice and adherence to personal or organizational API quotas.
*   **Chat History and Persistence**: All interactions and generated documentation are persistently stored in a MongoDB database. This enables users to:
    *   Maintain a history of their analysis sessions.
    *   Revisit previous reports and chat exchanges.
    *   Track feedback on the generated documentation.
...
*   **Usage:**
    *   **Calls:** No explicit calls identified.
    *   **Called By:** No explicit callers identified.
...
*   **Instantiation:** No explicit callers identified.
...
*   **Methods:**
    *   **`visit_Import`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `self.generic_visit` to continue AST traversal.
            *   **Called By:** This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.Import` node is encountered.
    *   **`visit_ImportFrom`**
        ...
        *   **Usage:**
            *   **Calls:** `self.generic_visit` to continue AST traversal.
            *   **Called By:** This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.ImportFrom` node is encountered.
    *   **`visit_ClassDef`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `ast.get_docstring`, `ast.get_source_segment`, and `self.generic_visit`.
            *   **Called By:** This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.ClassDef` node is encountered.
    *   **`visit_FunctionDef`**
        ...
        *   **Usage:**
            *   **Calls:** `ast.get_docstring`, `ast.get_source_segment`, and `self.generic_visit`.
            *   **Called By:** This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.FunctionDef` node is encountered, and also by `visit_AsyncFunctionDef`.
    *   **`visit_AsyncFunctionDef`**
        ...
        *   **Usage:**
            ...
            *   **Called By:** This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.AsyncFunctionDef` node is encountered.
...
*   **Dependencies:** `backend.AST_Schema.ASTVisitor`, `ast`, `os`
*   **Constructor:**
...
*   **Dependencies:** `get_all_temp_files`, `init_exports_symbol`, `module_file_exists`
*   **Constructor:**
...
*   **Methods:**
    ...
    *   **`visit_Import`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `self.generic_visit` to continue the AST traversal.
            *   **Called By:** This method is called by the AST NodeVisitor when encountering Import nodes, and explicitly by visit_ImportFrom to record dependencies.
    *   **`visit_ImportFrom`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `self.visit_Import` to record the dependency and `self._resolve_module_name` to handle relative imports. It also calls `self.generic_visit` to continue the AST traversal.
            *   **Called By:** This method is called by the AST NodeVisitor framework when traversing the AST and encountering an ImportFrom node.
...
*   **Methods:**
    *   **`call_llm`**
        ...
        *   **Usage:**
            *   **Calls:** `SystemMessage`, `HumanMessage`, `logging.info`, `self.llm.invoke`, and `logging.error`.
            *   **Called By:** No explicit callers identified.
    *   **`stream_llm`**
        ...
        *   **Usage:**
            *   **Calls:** `SystemMessage`, `HumanMessage`, `logging.info`, `self.llm.stream`, and `logging.error`.
            *   **Called By:** No explicit callers identified.
...
*   **Methods:**
    ...
    *   **`_extrahiere_sektion_aus_markdown`**
        ...
        *   **Usage:**
            *   **Calls:** `re.escape`, `re.compile`, and `pattern.search` for regular expression operations.
    ...
    *   **`_parse_readme`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `_clean_content`, `re.search`, and `_extrahiere_sektion_aus_markdown`.
            *   **Called By:** `extrahiere_info`.
    *   **`_parse_toml`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `_clean_content`, `tomllib.loads`, and `print`.
            *   **Called By:** `extrahiere_info`.
    *   **`_parse_requirements`**
    ...
    *   **`extrahiere_info`**
        ...
        *   **Usage:**
            *   **Calls:** `_finde_datei`, `_parse_toml`, `_parse_requirements`, `_parse_readme`, `os.path.basename`, and `repo_url.removesuffix`.
            *   **Called By:** No explicit callers identified.
...
*   **Methods:**
    ...
    *   **`visit_Import`**
        ...
        *   **Usage:**
            ...
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.Import` node is visited.
    *   **`visit_ImportFrom`**
        ...
        *   **Usage:**
            *   **Calls:** This method does not explicitly call other functions or methods within its own source code.
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.ImportFrom` node is visited.
    *   **`visit_ClassDef`**
        ...
        *   **Usage:**
            *   **Calls:** `self.generic_visit`.
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.ClassDef` node is visited.
    *   **`visit_FunctionDef`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `self._make_full_name`, `self.generic_visit`, `self.graph.add_node`, and `self.function_set.add`.
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.FunctionDef` node is visited, and by `visit_AsyncFunctionDef`.
    *   **`visit_AsyncFunctionDef`**
        ...
        *   **Usage:**
            *   **Calls:** `self.visit_FunctionDef`.
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.AsyncFunctionDef` node is visited.
    *   **`visit_Call`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `self._current_caller`, `self._recursive_call`, `self._resolve_all_callee_names`, and `self.generic_visit`. It also interacts with `self.edges`.
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.Call` node is visited.
    *   **`visit_If`**
        ...
        *   **Usage:**
            *   **Calls:** `self.generic_visit`.
            *   **Called By:** This method is called by the `ast.NodeVisitor` framework when an `ast.If` node is visited.
...
*   **Methods:**
    *   **`get_all_files`**
        ...
        *   **Usage:**
            *   **Calls:** `backend.getRepo.RepoFile` to create `RepoFile` instances.
            *   **Called By:** No explicit callers identified.
    *   **`close`**
...
*   **Dependencies:** `backend.relationship_analyzer.CallResolverVisitor`, `backend.relationship_analyzer.path_to_module`. It also utilizes standard library modules such as `ast`, `os`, `logging`, and `collections.defaultdict`.
*   **Constructor:**
...
*   **Methods:**
    *   **`analyze`**
        ...
        *   **Usage:**
            *   **Calls:** `_find_py_files`, `_collect_definitions`, and `_resolve_calls`.
            *   **Called By:** No explicit callers identified.
    ...
    *   **`_find_py_files`**
        ...
        *   **Usage:**
            *   **Calls:** `os.walk` and `os.path.join`.
            *   **Called By:** `analyze`.
    *   **`_collect_definitions`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `path_to_module`, `_get_parent`, `ast.parse`, `ast.walk`, `ast.FunctionDef`, `ast.ClassDef`, and `logging.error`.
            *   **Called By:** `analyze`.
    *   **`_get_parent`**
        ...
        *   **Usage:**
            *   **Calls:** `ast.walk` and `ast.iter_child_nodes`.
    ...
    *   **`_resolve_calls`**
        ...
        *   *Returns:* *None*
        *   **Usage:**
            *   **Calls:** `CallResolverVisitor` and `logging.error`.
            *   **Called By:** `analyze`.
...
*   **Methods:**
    *   **`visit_ClassDef`**
        ...
        *   **Usage:**
            ...
            *   **Called By:** This method is called by the AST visitor framework when a ClassDef node is encountered.
    *   **`visit_FunctionDef`**
        *   *Signature:* `def visit_FunctionDef(self, node: ast.FunctionDef)`
        ...
        *   **Usage:**
            *   **Calls:** This method calls the generic visitor method to continue traversing the AST.
            *   **Called By:** This method is called by the AST visitor framework when a FunctionDef node is encountered.
    *   **`visit_Call`**
        *   *Signature:* `def visit_Call(self, node: ast.Call)`
        ...
        *   **Usage:**
            ...
            *   **Called By:** This method is called by the AST visitor framework when a Call node is encountered.
    *   **`visit_Import`**
        *   *Signature:* `def visit_Import(self, node: ast.Import)`
        ...
        *   **Usage:**
            *   **Calls:** This method calls the generic visitor method to continue traversing the AST.
            *   **Called By:** This method is called by the AST visitor framework when an Import node is encountered.
    *   **`visit_ImportFrom`**
        *   *Signature:* `def visit_ImportFrom(self, node: ast.ImportFrom)`
        ...
        *   **Usage:**
            *   **Calls:** This method calls the generic visitor method to continue traversing the AST.
            *   **Called By:** This method is called by the AST visitor framework when an ImportFrom node is encountered.
    *   **`visit_Assign`**
        ...
        *   **Usage:**
            *   **Calls:** This method calls the generic visitor method to continue traversing the AST.
            *   **Called By:** This method is called by the AST visitor framework when an Assign node is encountered.
    *   **`_resolve_call_qname`**
        ...
        *   **Usage:**
            ...
            *   **Called By:** `visit_Call` to resolve the qualified name of a function or method invocation.
