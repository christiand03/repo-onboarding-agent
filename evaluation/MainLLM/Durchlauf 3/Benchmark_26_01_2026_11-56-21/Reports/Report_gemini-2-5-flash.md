...
## 1. Project Overview
    - **Description:** The Repo Onboarding Agent is an AI-powered system designed to streamline the process of understanding and documenting software repositories. It leverages various Large Language Models (LLMs) and static analysis techniques to extract, analyze, and synthesize critical project information, including code structure, dependencies, and functional descriptions. The agent aims to provide comprehensive, human-readable documentation to facilitate developer onboarding and project understanding.
    - **Key Features:** 
      - AI-powered repository analysis
      - Automated documentation generation for Python code and Jupyter notebooks
      - Dependency and call graph insights
      - Support for multiple LLM providers (Gemini, OpenAI, Ollama)
      - Interactive web-based user interface (Streamlit) for easy interaction and chat management
    - **Tech Stack:** Python, Streamlit, LangChain (Google Gemini API, OpenAI API, Ollama), MongoDB (for user/chat data), NetworkX (for graph analysis), pydantic (for data validation), GitPython (for repository cloning), nbformat (for notebook processing)

*   **Repository Structure:**
    ```mermaid
    graph LR
    PROJECT_ROOT_MARKER["Repo Onboarding Agent 🚀"]
    analysis_output_json["analysis_output.json"]
    backend["backend"]
    backend_AST_Schema_py_files["AST_Schema.py Files<br/>AST_Schema.py"]
    backend_File_Dependency_py_files["File_Dependency.py Files<br/>File_Dependency.py"]
    backend_HelperLLM_py_files["HelperLLM.py Files<br/>HelperLLM.py"]
    backend_MainLLM_py_files["MainLLM.py Files<br/>MainLLM.py"]
    backend_basic_info_py_files["basic_info.py Files<br/>basic_info.py"]
    backend_callgraph_py_files["callgraph.py Files<br/>callgraph.py"]
    backend_converter_py_files["converter.py Files<br/>converter.py"]
    backend_files["backend Files<br/>__init__.py<br/>main.py<br/>scads_key_test.py"]
    backend_getRepo_py_files["getRepo.py Files<br/>getRepo.py"]
    backend_relationship_analyzer_py_files["relationship_analyzer.py Files<br/>relationship_analyzer.py"]
    database["database"]
    database_db_py_files["db.py Files<br/>db.py"]
    env_example["_env.example"]
    frontend["frontend"]
    frontend__streamlit["_streamlit"]
    frontend__streamlit_config_toml_files["config.toml Files<br/>config.toml"]
    frontend_files["frontend Files<br/>__init__.py<br/>frontend.py"]
    frontend_gifs["gifs"]
    frontend_gifs_4j_gif_files["4j.gif Files<br/>4j.gif"]
    gitignore[".gitignore"]
    notizen["notizen"]
    notizen_grafiken["grafiken"]
    notizen_grafiken_1["1"]
    notizen_grafiken_1_files["1 Files<br/>File_Dependency_Graph_Repo.dot<br/>global_callgraph.png<br/>global_graph.png<br/>global_graph_2.png<br/>repo.dot"]
    notizen_grafiken_2["2"]
    notizen_grafiken_2_files["2 Files<br/>FDG_repo.dot<br/>fdg_graph.png<br/>fdg_graph_2.png<br/>filtered_callgraph_flask.png<br/>filtered_callgraph_repo-agent-3.dot<br/>filtered_callgraph_repo-agent.png<br/>filtered_repo_callgraph_flask.dot<br/>filtered_repo_callgraph_repo-agent-3.dot<br/>filtered_repo_callgraph_repo-agent.dot<br/>global_callgraph.png<br/>graph_flask.md<br/>repo.dot"]
    notizen_grafiken_Flask_Repo["Flask_Repo"]
    notizen_grafiken_Flask_Repo_files["Flask_Repo Files<br/>__init__.dot<br/>__main__.dot<br/>app.dot<br/>auth.dot<br/>blog.dot<br/>blueprints.dot<br/>cli.dot<br/>conf.dot<br/>config.dot<br/>conftest.dot<br/>ctx.dot<br/>db.dot<br/>debughelpers.dot<br/>factory.dot<br/>flask.dot<br/>globals.dot<br/>hello.dot<br/>helpers.dot<br/>importerrorapp.dot<br/>logging.dot<br/>make_celery.dot<br/>multiapp.dot<br/>provider.dot<br/>scaffold.dot<br/>sessions.dot<br/>signals.dot<br/>tag.dot<br/>tasks.dot<br/>templating.dot<br/>test_appctx.dot<br/>test_async.dot<br/>test_auth.dot<br/>test_basic.dot<br/>test_blog.dot<br/>test_blueprints.dot<br/>test_cli.dot<br/>test_config.dot<br/>test_config.png<br/>test_converters.dot<br/>test_db.dot<br/>test_factory.dot<br/>test_helpers.dot<br/>test_instance_config.dot<br/>test_js_example.dot<br/>test_json.dot<br/>test_json_tag.dot<br/>test_logging.dot<br/>test_regression.dot<br/>test_reqctx.dot<br/>test_request.dot<br/>test_session_interface.dot<br/>test_signals.dot<br/>test_subclassing.dot<br/>test_templating.dot<br/>test_testing.dot<br/>test_user_error_handler.dot<br/>test_views.dot<br/>testing.dot<br/>typing.dot<br/>typing_app_decorators.dot<br/>typing_error_handler.dot<br/>typing_route.dot<br/>views.dot<br/>wrappers.dot<br/>wsgi.dot"]
    notizen_grafiken_Repo_onboarding["Repo_onboarding"]
    notizen_grafiken_Repo_onboarding_files["Repo_onboarding Files<br/>AST.dot<br/>Frontend.dot<br/>HelperLLM.dot<br/>HelperLLM.png<br/>MainLLM.dot<br/>agent.dot<br/>basic_info.dot<br/>callgraph.dot<br/>getRepo.dot<br/>graph_AST.png<br/>graph_AST2.png<br/>graph_AST3.png<br/>main.dot<br/>tools.dot<br/>types.dot"]
    notizen_files["notizen Files<br/>Report Agenda.txt<br/>Zwischenpraesentation Agenda.txt<br/>doc_bestandteile.md<br/>notizen.md<br/>paul_notizen.md<br/>praesentation_notizen.md<br/>technische_notizen.md"]
    output_json["output.json"]
    output_toon["output.toon"]
    readme_md["readme.md"]
    requirements_txt["requirements.txt"]
    result["result"]
    result_files["result Files<br/>ast_schema_01_12_2025_11-49-24.json<br/>notebook_report_23_12_2025_12-56-24_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-06-09_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-09-29_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-26-34_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-33-06_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_29_12_2025_15-03-21_NotebookLLM_gemini-2.5-flash.md<br/>report_01_12_2025_12-26-46_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_12-55-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_13-37-30_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-15-04_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-42-38_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_22-46-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.md<br/>report_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.md<br/>report_14_11_2025_14-52-36.md<br/>report_14_11_2025_15-21-53.md<br/>report_14_11_2025_15-26-24.md<br/>report_21_11_2025_15-43-30.md<br/>report_21_11_2025_16-06-12.md<br/>report_22_11_2025_14-01-50_Helper_llama3_Main_geminipro.md<br/>report_22_11_2025_14-39-55_Helper_llama3_MainLLM_llama3.md<br/>result_2025-11-11_12-30-53.md<br/>result_2025-11-11_12-43-51.md<br/>result_2025-11-11_12-45-37.md"]
    schemas["schemas"]
    schemas_types_py_files["types.py Files<br/>types.py"]
    statistics["statistics"]
    statistics_files["statistics Files<br/>savings_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.png<br/>savings_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.png<br/>savings_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.png<br/>savings_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.png<br/>savings_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.png"]
    SystemPrompts["SystemPrompts"]
    SystemPrompts_files["SystemPrompts Files<br/>SystemPromptClassHelperLLM.txt<br/>SystemPromptFunctionHelperLLM.txt<br/>SystemPromptHelperLLM.txt<br/>SystemPromptMainLLM.txt<br/>SystemPromptMainLLMToon.txt<br/>SystemPromptNotebookLLM.txt"]
    test_json["test.json"]
    PROJECT_ROOT_MARKER --> analysis_output_json
    PROJECT_ROOT_MARKER --> backend
    PROJECT_ROOT_MARKER --> database
    PROJECT_ROOT_MARKER --> env_example
    PROJECT_ROOT_MARKER --> frontend
    PROJECT_ROOT_MARKER --> gitignore
    PROJECT_ROOT_MARKER --> notizen
    PROJECT_ROOT_MARKER --> output_json
    PROJECT_ROOT_MARKER --> output_toon
    PROJECT_ROOT_MARKER --> readme_md
    PROJECT_ROOT_MARKER --> requirements_txt
    PROJECT_ROOT_MARKER --> result
    PROJECT_ROOT_MARKER --> schemas
    PROJECT_ROOT_MARKER --> statistics
    PROJECT_ROOT_MARKER --> SystemPrompts
    PROJECT_ROOT_MARKER --> test_json
    backend --> backend_AST_Schema_py_files
    backend --> backend_File_Dependency_py_files
    backend --> backend_HelperLLM_py_files
    backend --> backend_MainLLM_py_files
    backend --> backend_basic_info_py_files
    backend --> backend_callgraph_py_files
    backend --> backend_converter_py_files
    backend --> backend_files
    backend --> backend_getRepo_py_files
    backend --> backend_relationship_analyzer_py_files
    database --> database_db_py_files
    frontend --> frontend__streamlit
    frontend --> frontend_files
    frontend --> frontend_gifs
    frontend__streamlit --> frontend__streamlit_config_toml_files
    frontend_gifs --> frontend_gifs_4j_gif_files
    notizen --> notizen_files
    notizen --> notizen_grafiken
    notizen_grafiken --> notizen_grafiken_1
    notizen_grafiken --> notizen_grafiken_2
    notizen_grafiken --> notizen_grafiken_Flask_Repo
    notizen_grafiken --> notizen_grafiken_Repo_onboarding
    notizen_grafiken_1 --> notizen_grafiken_1_files
    notizen_grafiken_2 --> notizen_grafiken_2_files
    notizen_grafiken_Flask_Repo --> notizen_grafiken_Flask_Repo_files
    notizen_grafiken_Repo_onboarding --> notizen_grafiken_Repo_onboarding_files
    result --> result_files
    schemas --> schemas_types_py_files
...
- nbformat
### Setup Guide
Setup instructions could not be automatically extracted.
### Quick Startup
Quick startup guide could not be automatically extracted.

To run the Streamlit application (UI):
```bash
streamlit run frontend/frontend.py
```

## 3. Use Cases & Commands
The Repo Onboarding Agent provides a web-based interface for users to input a Git repository URL and receive an automatically generated, detailed documentation report. It analyzes the repository's structure, code components (functions, classes), and their interdependencies, offering insights into the project's architecture and functionality. Users can also process Jupyter notebooks within repositories, generate specialized reports, and manage their API keys and chat interactions through a persistent database.

**Primary Commands:**
The primary interaction with this agent is through its Streamlit web user interface. Once the application is running, users can interact with it via their web browser.
...
- Provide a Git repository URL for analysis.
- Select different LLM models for documentation generation.
- Review generated documentation for code files and Jupyter notebooks.
- Manage API keys for various LLM services.
- Engage in chat interactions and manage conversation history.
...
*   **Instantiation:** Not explicitly instantiated by any known components in the provided context.
...
*   **Methods:**
    *   **`analyze_repository`**
        ...
        *   **Usage:** Calls: This method calls 'os.path.commonpath', 'os.path.isfile', 'os.path.dirname', 'ast.parse', and instantiates 'ASTVisitor'. Called by: This method is not explicitly called by any other functions or methods in the provided context.
    *   **`__init__`**
        *   *Signature:* `def __init__(self: )`
        *   *Description:* This constructor initializes the ASTAnalyzer class. It does not take any specific parameters beyond 'self' and performs no explicit setup or attribute assignments, effectively creating a stateless instance.
        *   *Parameters:* None
        *   *Returns:* None
        *   **Usage:** No explicit usage context found.
    *   **`merge_relationship_data`**
        ...
        *   **Usage:** Calls: This method primarily uses dictionary 'get' methods and iterates over data structures. It does not call other distinct functions or classes. Called by: This method is not explicitly called by any other functions or methods in the provided context.
...
*   **Instantiation:** Not explicitly instantiated by any known components within the provided context.
...
*   **Methods:**
    *   **`__init__`**
        ...
        *   *Parameters:*
            ...
            - **project_root** (`str`): The root directory of the project, used to determine the module path.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `path_to_module` to convert the file path into a module path. Called by: No explicit usage context found.
    *   **`visit_AsyncFunctionDef`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `self.visit_FunctionDef`. Called by: This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.AsyncFunctionDef` node is encountered.
    *   **`visit_ClassDef`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `ast.get_docstring`, `ast.get_source_segment`, and `self.generic_visit`. Called by: This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.ClassDef` node is encountered.
    *   **`visit_FunctionDef`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `ast.get_docstring`, `ast.get_source_segment`, and `self.generic_visit`. Called by: This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.FunctionDef` node is encountered, and also by `visit_AsyncFunctionDef`.
    *   **`visit_Import`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `self.generic_visit` to continue AST traversal. Called by: This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.Import` node is encountered.
    *   **`visit_ImportFrom`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `self.generic_visit` to continue AST traversal. Called by: This method is called by the `ast.NodeVisitor`'s dispatch mechanism when an `ast.ImportFrom` node is encountered.
...
*   **Usage:** Calls: This function calls backend.File_Dependency.FileDependencyGraph. Called by: This function is called by no other functions.
...
*   **Usage:** Calls: This function calls backend.File_Dependency.build_file_dependency_graph. Called by: This function is not explicitly called by any other functions in the provided context.
...
*   **Instantiation:** Not explicitly shown to be instantiated by other components within the provided context.
...
*   **Methods:**
    ...
    *   **`visit_Import`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self.generic_visit to continue the AST traversal. Called by: This method is called by the AST NodeVisitor when encountering Import nodes, and explicitly by visit_ImportFrom to record dependencies.
    *   **`visit_ImportFrom`**
        *   *Signature:* `def visit_ImportFrom(self: , node: )`
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self.visit_Import to record the dependency and self._resolve_module_name to handle relative imports. It also calls self.generic_visit to continue the AST traversal. Called by: This method is called by the AST NodeVisitor framework when traversing the AST and encountering an ImportFrom node.
...
*   **Description:** This function serves as a dummy data and processing loop, primarily for testing the LLMHelper class. It defines pre-computed analysis inputs and outputs for several example functions, such as 'add_item', 'check_stock', and 'generate_report', using Pydantic models. It then instantiates an LLMHelper and simulates generating documentation for these functions, logging the process and displaying the final aggregated results. The function demonstrates how to use the `FunctionAnalysisInput` and `FunctionAnalysis` models.
    *   **Parameters:** None
    *   **Returns:** None
*   **Usage:** Calls: This function calls backend.HelperLLM.LLMHelper, schemas.types.ClassAnalysisInput, and schemas.types.ClassContextInput. Called by: This function is called by no other functions.
...
*   **Methods:**
    *   **`__init__`**
        *   *Signature:* `def __init__(self: , api_key: str, function_prompt_path: str, class_prompt_path: str, model_name: str, base_url: )`
        *   *Description:* The constructor initializes the LLMHelper instance by setting up the API key, loading system prompts for function and class analysis from specified file paths, and configuring the underlying Language Model (LLM) based on the `model_name`. It supports various LLM providers like Google Gemini, OpenAI, custom APIs, and Ollama, and also configures batch processing settings.
        *   *Parameters:*
            ...
            - **class_prompt_path** (`str`): The file path to the system prompt used for class analysis.
            - **model_name** (`str`): The name of the LLM model to use (default: "gemini-2.0-flash-lite").
            - **base_url** (`None`): An optional base URL for custom LLM endpoints, particularly for Ollama or custom OpenAI-compatible APIs.
        *   *Returns:* None
        *   **Usage:** No explicit usage context found.
    *   **`_configure_batch_settings`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method does not explicitly call other methods, classes, or functions based on the provided context. Called by: This method is not explicitly called by other functions or methods based on the provided context.
...
*   **Instantiation:** Not explicitly instantiated by other components in the provided context.
...
*   **Methods:**
    *   **`__init__`**
        *   *Signature:* `def __init__(self: , api_key: str, prompt_file_path: str, model_name: str, base_url: )`
        *   *Description:* The constructor initializes the MainLLM instance by setting up the system prompt from a specified file and configuring the underlying Large Language Model (LLM) client based on the provided model name. It supports various LLM providers and performs validation for the API key and prompt file path, raising errors if essential configurations are missing.
        *   *Parameters:*
            ...
            - **prompt_file_path** (`str`): The file path to the system prompt that will be used for LLM interactions.
            - **model_name** (`str`): The name of the LLM model to use, defaulting to 'gemini-2.5-pro'. This parameter determines which LLM client (Gemini, OpenAI, Ollama) is initialized.
            - **base_url** (`None`): An optional base URL for custom LLM endpoints, primarily used for Ollama or other OpenAI-compatible services if the SCADSLLM_URL environment variable is not set.
        *   *Returns:* None
        *   **Usage:** No explicit usage context found.
    *   **`call_llm`**
        ...
        *   **Usage:** Calls: This method calls SystemMessage, HumanMessage, logging.info, self.llm.invoke, and logging.error. Called by: This method is not explicitly called by other methods in the provided context.
    *   **`stream_llm`**
        ...
        *   **Usage:** Calls: This method calls SystemMessage, HumanMessage, logging.info, self.llm.stream, and logging.error. Called by: This method is not explicitly called by other methods in the provided context.
...
*   **Methods:**
    ...
    *   **`_clean_content`**
        ...
        *   **Usage:** Calls: This method does not call any other functions or methods. Called by: This method is called by _parse_readme, _parse_toml, and _parse_requirements.
    *   **`_extrahiere_sektion_aus_markdown`**
        ...
        *   **Usage:** Calls: This method calls re.escape, re.compile, and pattern.search for regular expression operations. Called by: This method is called by _parse_readme.
    *   **`_finde_datei`**
        ...
        *   **Usage:** Calls: This method does not call any other functions or methods. Called by: This method is called by extrahiere_info.
    *   **`_parse_readme`**
    ...
    *   **`_parse_toml`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls _clean_content, tomllib.loads, and print. Called by: This method is called by extrahiere_info.
    *   **`extrahiere_info`**
        ...
        *   **Usage:** Calls: This method calls _finde_datei, _parse_toml, _parse_requirements, _parse_readme, os.path.basename, and repo_url.removesuffix. Called by: This method is not explicitly called by other methods within the provided context, suggesting it is a primary entry point for external usage.
...
*   **Usage:** Calls: This function calls backend.callgraph.CallGraph. Called by: This function is called by no other functions.

#### Function: `make_safe_dot`
*   **Signature:** `def make_safe_dot(graph: , out_path: str)`
...
*   **Instantiation:** Not explicitly instantiated by any known entities based on the provided context.
...
*   **Methods:**
    *   **`__init__`**
        *   *Signature:* `def __init__(self: , filename: str)`
        *   *Description:* Initializes the CallGraph instance, setting up the filename, tracking current function and class context during AST traversal, and initializing data structures like local_defs, graph (a NetworkX DiGraph), import_mapping, function_set, and edges to store call graph information.
        *   *Parameters:*
    ...
    *   **`_current_caller`**
        ...
        *   **Usage:** Calls: This method does not explicitly call other functions or methods within its own source code. Called by: This method is called by visit_Call.
    *   **`_make_full_name`**
        *   *Signature:* `def _make_full_name(self: , basename: str, class_name: )`
        ...
        *   **Usage:** Calls: This method does not explicitly call other functions or methods within its own source code. Called by: This method is called by visit_FunctionDef.
    *   **`_recursive_call`**
    ...
    *   **`visit_AsyncFunctionDef`**
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.AsyncFunctionDef`): The AST node representing an asynchronous function definition.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self.visit_FunctionDef. Called by: This method is called by the ast.NodeVisitor framework when an ast.AsyncFunctionDef node is visited.
    *   **`visit_Call`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self._current_caller, self._recursive_call, self._resolve_all_callee_names, and self.generic_visit. It also interacts with self.edges. Called by: This method is called by the ast.NodeVisitor framework when an ast.Call node is visited.
    *   **`visit_ClassDef`**
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.ClassDef`): The AST node representing a class definition.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self.generic_visit. Called by: This method is called by the ast.NodeVisitor framework when an ast.ClassDef node is visited.
    *   **`visit_FunctionDef`**
        *   *Signature:* `def visit_FunctionDef(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.FunctionDef`): The AST node representing a function definition.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self._make_full_name, self.generic_visit, self.graph.add_node, and self.function_set.add. Called by: This method is called by the ast.NodeVisitor framework when an ast.FunctionDef node is visited, and by visit_AsyncFunctionDef.
    *   **`visit_If`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self.generic_visit. Called by: This method is called by the ast.NodeVisitor framework when an ast.If node is visited.
    *   **`visit_Import`**
        *   *Signature:* `def visit_Import(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.Import`): The AST node representing an import statement.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls self.generic_visit. Called by: This method is called by the ast.NodeVisitor framework when an ast.Import node is visited.
    *   **`visit_ImportFrom`**
        *   *Signature:* `def visit_ImportFrom(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.ImportFrom`): The AST node representing a from ... import ... statement.
        *   *Returns:* None
        *   **Usage:** Calls: This method does not explicitly call other functions or methods within its own source code. Called by: This method is called by the ast.NodeVisitor framework when an ast.ImportFrom node is visited.
...
*   **Usage:** Calls: This function calls backend.converter.process_image. Called by: This function is not explicitly called by any other functions in the provided context.
...
*   **Methods:**
    *   **`__enter__`**
        ...
        *   **Usage:** Calls: This method does not explicitly call other functions or methods. Called by: This method is not explicitly called by other methods in the provided context.
    *   **`__exit__`**
    ...
    *   **`get_all_files`**
        ...
        *   **Usage:** Calls: This method calls `backend.getRepo.RepoFile` to create `RepoFile` instances. Called by: This method is not explicitly called by other methods in the provided context.
    *   **`get_file_tree`**
...
*   **Instantiation:** Not explicitly shown to be instantiated by other components in the provided context.
...
*   **Methods:**
    *   **`__init__`**
        ...
        *   *Parameters:*
            ...
            - **file_path** (`str`): The path to the file within the repository.
            - **commit_tree** (`git.Tree`): The Tree object of the commit, from which the file originated.
        *   *Returns:* None
        *   **Usage:** No explicit usage context found.
    *   **`__repr__`**
        ...
        *   **Usage:** Calls: This method does not explicitly call other methods or functions. Called by: This method is not explicitly called by other components.
    *   **`analyze_word_count`**
...
*   **Signature:** `def create_savings_chart(json_tokens: , toon_tokens: , savings_percent: , output_path: str)`
...
*   **Signature:** `def gemini_payload(basic_info: , nb_path: str, xml_content: str, images: )`
...
*   **Usage:** Calls: This function calls backend.MainLLM.MainLLM, backend.MainLLM.MainLLM.call_llm, backend.basic_info.ProjektInfoExtractor, backend.basic_info.ProjektInfoExtractor.extrahiere_info, backend.converter.process_repo_notebooks, backend.getRepo.GitRepository, backend.main.gemini_payload, and backend.main.update_status. Called by: This function is not called by any other functions.
...
*   **Methods:**
    *   **`__init__`**
        ...
        *   *Parameters:*
            ...
            - **definitions** (`dict`): A dictionary containing known fully qualified definitions within the project, used for validating resolved call targets.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `backend.relationship_analyzer.path_to_module` to convert the file path into a module path. Called by: No explicit usage context found.
    *   **`_resolve_call_qname`**
        ...
        *   **Usage:** Calls: This method does not explicitly call other methods within its own source code. Called by: This method is called by `visit_Call` to resolve the qualified name of a function or method invocation.
    *   **`visit_Assign`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls the generic visitor method to continue traversing the AST. Called by: This method is called by the AST visitor framework when an Assign node is encountered.
    *   **`visit_Call`**
        *   *Signature:* `def visit_Call(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.Call`): The AST node representing a function or method call.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls `_resolve_call_qname` to determine the callee's qualified name and the generic visitor method to continue traversing the AST. Called by: This method is called by the AST visitor framework when a Call node is encountered.
    *   **`visit_ClassDef`**
        *   *Signature:* `def visit_ClassDef(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.ClassDef`): The AST node representing a class definition.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls the generic visitor method to continue traversing the AST. Called by: This method is called by the AST visitor framework when a ClassDef node is encountered.
    *   **`visit_FunctionDef`**
        *   *Signature:* `def visit_FunctionDef(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.FunctionDef`): The AST node representing a function definition.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls the generic visitor method to continue traversing the AST. Called by: This method is called by the AST visitor framework when a FunctionDef node is encountered.
    *   **`visit_Import`**
        *   *Signature:* `def visit_Import(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.Import`): The AST node representing an import statement.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls the generic visitor method to continue traversing the AST. Called by: This method is called by the AST visitor framework when an Import node is encountered.
    *   **`visit_ImportFrom`**
        *   *Signature:* `def visit_ImportFrom(self: , node: )`
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.ImportFrom`): The AST node representing a 'from ... import ...' statement.
        *   *Returns:* None
        *   **Usage:** Calls: This method calls the generic visitor method to continue traversing the AST. Called by: This method is called by the AST visitor framework when an ImportFrom node is encountered.
...
*   **Instantiation:** Not explicitly instantiated by any entities listed in the provided context.
...
*   **Methods:**
    ...
    *   **`_resolve_calls`**
        ...
        *   *Returns:* None
        *   **Usage:** Calls: This method calls CallResolverVisitor and logging.error. Called by: This method is called by analyze.
    *   **`analyze`**
        ...
        *   **Usage:** Calls: This method calls _find_py_files, _collect_definitions, and _resolve_calls. Called by: This method is not explicitly called by other methods within the provided method_context.
    *   **`get_raw_relationships`**
        ...
        *   **Usage:** Calls: This method does not explicitly call other methods, classes, or functions within its source code. Called by: This method is not explicitly called by other methods within the provided method_context.
...
*   **Signature:** `def insert_exchange(question: str, answer: str, feedback: str, username: str, chat_name: str, helper_used: str, main_used: str, total_time: str, helper_time: str, main_time: str, json_tokens: , toon_tokens: , savings_percent: )`
...
*   **Description:** This function handles the deletion of a specified chat for a given user. It first calls the database to delete the full chat record. Subsequently, it cleans up the chat from the Streamlit session state. If other chats exist, it sets the first available chat as the active one; otherwise, it creates a new default chat named 'Chat 1' and sets it as active. Finally, it triggers a Streamlit rerun to update the UI.
    *   **Parameters:**
        - **username** (`Any`): The username associated with the chat to be deleted.
        - **chat_name** (`Any`): The name of the chat to be deleted.
    *   **Returns:** None
*   **Usage:** Calls: This function calls database.db.delete_full_chat and database.db.insert_chat. Called by: This function is not explicitly called by any other functions in the provided context.
...
*   **Description:** This function handles the deletion of a specific exchange. It first removes the exchange from the database using its ID. Subsequently, it updates the Streamlit session state by locating the associated chat and removing the exchange from its list of exchanges. Finally, it triggers a full Streamlit rerun to reflect these changes in the UI.
    *   **Parameters:**
        - **chat_name** (`Any`): The name of the chat to which the exchange belongs, used to locate it within the Streamlit session state.
...
*   **Description:** This function handles changes to feedback for an exchange object. It updates the 'feedback' key of the provided exchange dictionary 'ex' with the new 'val'. Subsequently, it persists this feedback change to the database by calling 'db.update_exchange_feedback' using the exchange's '_id' and the new feedback value. Finally, it triggers a rerun of the Streamlit application to reflect the changes in the UI.
    ...
    *   **Returns:** None
*   **Usage:** Calls: This function calls database.db.update_exchange_feedback. Called by: This function is not explicitly called by any other functions in the provided context.
...
*   **Description:** This function `load_data_from_db` is designed to load chat and exchange data for a specific user from the database into the Streamlit session state. It first verifies if the data for the provided username is already loaded to avoid redundant operations. The process involves fetching predefined chats, then loading individual exchanges and associating them with their respective chats, including support for legacy data where exchanges might exist for undefined chats. Finally, it ensures that at least one chat exists, creating a default 'Chat 1' if none are found, and sets an active chat for the user's session state.
    ...
    *   **Returns:** None
*   **Usage:** Calls: This function calls database.db.fetch_chats_by_user, database.db.fetch_exchanges_by_user, and database.db.insert_chat. Called by: This function is called by no other functions.
...
*   **Description:** The `render_exchange` function is responsible for displaying a single chat exchange, consisting of a user's question and an assistant's answer, within a Streamlit application. It first renders the user's question. Subsequently, it displays the assistant's response along with an interactive toolbar. This toolbar provides functionalities such as feedback (like/dislike), adding comments, downloading the response, and deleting the exchange. In cases where the answer indicates an error, a simplified error message and a delete option are presented. Finally, the function uses `render_text_with_mermaid` to display the answer content.
    ...
    *   **Returns:** None
*   **Usage:** Calls: This function calls database.db.update_exchange_feedback_message, frontend.frontend.handle_delete_exchange, frontend.frontend.handle_feedback_change, and frontend.frontend.render_text_with_mermaid. Called by: This function is not explicitly called by any other functions in the provided context.
...
*   **Description:** This function processes a given markdown text, identifying and rendering embedded Mermaid diagrams. It splits the input text into parts based on '```mermaid' delimiters. Non-Mermaid text is rendered as standard markdown, optionally streamed if 'should_stream' is true. Mermaid diagram code blocks are attempted to be rendered using 'st_mermaid', with a fallback to displaying the code block if rendering fails. The function handles cases where the input markdown text is empty by returning early.
    ...
    *   **Returns:** None
*   **Usage:** Calls: This function calls frontend.frontend.stream_text_generator. Called by: This function is not explicitly called by any other functions in the provided context.
...
*   **Description:** This function, `save_ollama_cb`, is designed to save a user-provided Ollama URL. It retrieves the potential new URL from the Streamlit session state under the key 'in_ollama_url'. If a valid, non-empty URL is found, the function proceeds to update this URL in the database. The update operation uses the current user's username, also retrieved from the session state, to associate the URL. Upon successful database update, a confirmation toast message is displayed to the user.
    *   **Parameters:** None
    *   **Returns:** None
*   **Usage:** Calls: This function calls database.db.update_ollama_url. Called by: This function is not explicitly called by any other functions in the provided context.
