...
## 1. Project Overview
- **Description:** This project, named 'Repo Onboarding Agent 🚀', is a Python-based automated documentation pipeline. It streamlines the process of understanding new code repositories by leveraging Large Language Models (LLMs) to perform detailed code analysis. The agent extracts project metadata, analyzes file structures, and provides comprehensive insights into functions, classes, and their interdependencies, all presented through a user-friendly interface.
- **Key Features:**
  - Automated cloning and analysis of Git repositories.
  - LLM-powered generation of structured code documentation.
  - Detailed analysis of functions and classes, including their purpose, parameters, returns, and usage context.
  - Visualization of repository structure.
  - Interactive Streamlit frontend for user interaction, API key management, and chat-based queries.
- **Tech Stack:** Python, Streamlit, GitPython, LangChain (with Google Gemini API, OpenAI API, Ollama integrations), MongoDB, Pydantic, NetworkX.

*   **Repository Structure:**
    ```mermaid
    graph LR
        SystemPrompts_SystemPromptClassHelperLLM_txt["SystemPromptClassHelperLLM.txt"]
        SystemPrompts_SystemPromptFunctionHelperLLM_txt["SystemPromptFunctionHelperLLM.txt"]
        SystemPrompts_SystemPromptHelperLLM_txt["SystemPromptHelperLLM.txt"]
        SystemPrompts_SystemPromptMainLLM_txt["SystemPromptMainLLM.txt"]
        SystemPrompts_SystemPromptMainLLMToon_txt["SystemPromptMainLLMToon.txt"]
        SystemPrompts_SystemPromptNotebookLLM_txt["SystemPromptNotebookLLM.txt"]
        backend_AST_Schema_py["AST_Schema.py"]
        backend_File_Dependency_py["File_Dependency.py"]
        backend_HelperLLM_py["HelperLLM.py"]
        backend_MainLLM_py["MainLLM.py"]
        backend___init___py["__init__.py"]
        backend_basic_info_py["basic_info.py"]
        backend_callgraph_py["callgraph.py"]
        backend_converter_py["converter.py"]
        backend_getRepo_py["getRepo.py"]
        backend_main_py["main.py"]
        backend_relationship_analyzer_py["relationship_analyzer.py"]
        backend_scads_key_test_py["scads_key_test.py"]
        database_db_py["db.py"]
        frontend__init___py["__init__.py"]
        frontend_dot_streamlit_config_toml["config.toml"]
        frontend_frontend_py["frontend.py"]
        frontend_gifs_4j_gif["4j.gif"]
        notizen_Report_Agenda_txt["Report Agenda.txt"]
        notizen_Zwischenpraesentation_Agenda_txt["Zwischenpraesentation Agenda.txt"]
        notizen_doc_bestandteile_md["doc_bestandteile.md"]
        notizen_grafiken_1_File_Dependency_Graph_Repo_dot["File_Dependency_Graph_Repo.dot"]
        notizen_grafiken_1_global_callgraph_png["global_callgraph.png"]
        notizen_grafiken_1_global_graph_2_png["global_graph_2.png"]
        notizen_grafiken_1_global_graph_png["global_graph.png"]
        notizen_grafiken_1_repo_dot["repo.dot"]
        notizen_grafiken_2_FDG_repo_dot["FDG_repo.dot"]
        notizen_grafiken_2_fdg_graph_2_png["fdg_graph_2.png"]
        notizen_grafiken_2_fdg_graph_png["fdg_graph.png"]
        notizen_grafiken_2_filtered_callgraph_flask_png["filtered_callgraph_flask.png"]
        notizen_grafiken_2_filtered_callgraph_repo_agent_3_png["filtered_callgraph_repo-agent_3.png"]
        notizen_grafiken_2_filtered_callgraph_repo_agent_png["filtered_callgraph_repo-agent.png"]
        notizen_grafiken_2_filtered_repo_callgraph_flask_dot["filtered_repo_callgraph_flask.dot"]
        notizen_grafiken_2_filtered_repo_callgraph_repo_agent_3_dot["filtered_repo_callgraph_repo-agent-3.dot"]
        notizen_grafiken_2_filtered_repo_callgraph_repo_agent_dot["filtered_repo_callgraph_repo-agent.dot"]
        notizen_grafiken_2_global_callgraph_png["global_callgraph.png"]
        notizen_grafiken_2_graph_flask_md["graph_flask.md"]
        notizen_grafiken_2_repo_dot["repo.dot"]
        notizen_grafiken_Flask_Repo___init___dot["__init__.dot"]
        notizen_grafiken_Flask_Repo___main___dot["__main__.dot"]
        notizen_grafiken_Flask_Repo_app_dot["app.dot"]
        notizen_grafiken_Flask_Repo_auth_dot["auth.dot"]
        notizen_grafiken_Flask_Repo_blog_dot["blog.dot"]
        notizen_grafiken_Flask_Repo_blueprints_dot["blueprints.dot"]
        notizen_grafiken_Flask_Repo_cli_dot["cli.dot"]
        notizen_grafiken_Flask_Repo_conf_dot["conf.dot"]
        notizen_grafiken_Flask_Repo_config_dot["config.dot"]
        notizen_grafiken_Flask_Repo_config_png["config.png"]
        notizen_grafiken_Flask_Repo_conftest_dot["conftest.dot"]
        notizen_grafiken_Flask_Repo_ctx_dot["ctx.dot"]
        notizen_grafiken_Flask_Repo_db_dot["db.dot"]
        notizen_grafiken_Flask_Repo_debughelpers_dot["debughelpers.dot"]
        notizen_grafiken_Flask_Repo_factory_dot["factory.dot"]
        notizen_grafiken_Flask_Repo_flask_dot["flask.dot"]
        notizen_grafiken_Flask_Repo_globals_dot["globals.dot"]
        notizen_grafiken_Flask_Repo_hello_dot["hello.dot"]
        notizen_grafiken_Flask_Repo_helpers_dot["helpers.dot"]
        notizen_grafiken_Flask_Repo_importerrorapp_dot["importerrorapp.dot"]
        notizen_grafiken_Flask_Repo_logging_dot["logging.dot"]
        notizen_grafiken_Flask_Repo_make_celery_dot["make_celery.dot"]
        notizen_grafiken_Flask_Repo_multiapp_dot["multiapp.dot"]
        notizen_grafiken_Flask_Repo_provider_dot["provider.dot"]
        notizen_grafiken_Flask_Repo_scaffold_dot["scaffold.dot"]
        notizen_grafiken_Flask_Repo_sessions_dot["sessions.dot"]
        notizen_grafiken_Flask_Repo_signals_dot["signals.dot"]
        notizen_grafiken_Flask_Repo_tag_dot["tag.dot"]
        notizen_grafiken_Flask_Repo_tasks_dot["tasks.dot"]
        notizen_grafiken_Flask_Repo_templating_dot["templating.dot"]
        notizen_grafiken_Flask_Repo_test_appctx_dot["test_appctx.dot"]
        notizen_grafiken_Flask_Repo_test_async_dot["test_async.dot"]
        notizen_grafiken_Flask_Repo_test_auth_dot["test_auth.dot"]
        notizen_grafiken_Flask_Repo_test_basic_dot["test_basic.dot"]
        notizen_grafiken_Flask_Repo_test_blog_dot["test_blog.dot"]
        notizen_grafiken_Flask_Repo_test_blueprints_dot["test_blueprints.dot"]
        notizen_grafiken_Flask_Repo_test_cli_dot["test_cli.dot"]
        notizen_grafiken_Flask_Repo_test_config_dot["test_config.dot"]
        notizen_grafiken_Flask_Repo_test_converters_dot["test_converters.dot"]
        notizen_grafiken_Flask_Repo_test_db_dot["test_db.dot"]
        notizen_grafiken_Flask_Repo_test_factory_dot["test_factory.dot"]
        notizen_grafiken_Flask_Repo_test_helpers_dot["test_helpers.dot"]
        notizen_grafiken_Flask_Repo_test_instance_config_dot["test_instance_config.dot"]
        notizen_grafiken_Flask_Repo_test_js_example_dot["test_js_example.dot"]
        notizen_grafiken_Flask_Repo_test_json_dot["test_json.dot"]
        notizen_grafiken_Flask_Repo_test_json_tag_dot["test_json_tag.dot"]
        notizen_grafiken_Flask_Repo_test_logging_dot["test_logging.dot"]
        notizen_grafiken_Flask_Repo_test_regression_dot["test_regression.dot"]
        notizen_grafiken_Flask_Repo_test_reqctx_dot["test_reqctx.dot"]
        notizen_grafiken_Flask_Repo_test_request_dot["test_request.dot"]
        notizen_grafiken_Flask_Repo_test_session_interface_dot["test_session_interface.dot"]
        notizen_grafiken_Flask_Repo_test_signals_dot["test_signals.dot"]
        notizen_grafiken_Flask_Repo_test_subclassing_dot["test_subclassing.dot"]
        notizen_grafiken_Flask_Repo_test_templating_dot["test_templating.dot"]
        notizen_grafiken_Flask_Repo_test_testing_dot["test_testing.dot"]
        notizen_grafiken_Flask_Repo_test_user_error_handler_dot["test_user_error_handler.dot"]
        notizen_grafiken_Flask_Repo_test_views_dot["test_views.dot"]
        notizen_grafiken_Flask_Repo_testing_dot["testing.dot"]
        notizen_grafiken_Flask_Repo_typing_app_decorators_dot["typing_app_decorators.dot"]
        notizen_grafiken_Flask_Repo_typing_dot["typing.dot"]
        notizen_grafiken_Flask_Repo_typing_error_handler_dot["typing_error_handler.dot"]
        notizen_grafiken_Flask_Repo_typing_route_dot["typing_route.dot"]
        notizen_grafiken_Flask_Repo_views_dot["views.dot"]
        notizen_grafiken_Flask_Repo_wrappers_dot["wrappers.dot"]
        notizen_grafiken_Flask_Repo_wsgi_dot["wsgi.dot"]
        notizen_notizen_md["notizen.md"]
        notizen_paul_notizen_md["paul_notizen.md"]
        notizen_praesentation_notizen_md["praesentation_notizen.md"]
        notizen_technische_notizen_md["technische_notizen.md"]
        result_ast_schema_01_12_2025_11_49_24_json["ast_schema_01_12_2025_11-49-24.json"]
        result_notebook_report_23_12_2025_12_56_24_NotebookLLM_gemini_2_5_flash_md["notebook_report_23_12_2025_12-56-24_NotebookLLM_gemini-2.5-flash.md"]
        result_notebook_report_27_12_2025_15_06_09_NotebookLLM_gemini_2_5_flash_md["notebook_report_27_12_2025_15-06-09_NotebookLLM_gemini-2.5-flash.md"]
        result_notebook_report_27_12_2025_15_09_29_NotebookLLM_gemini_2_5_flash_md["notebook_report_27_12_2025_15-09-29_NotebookLLM_gemini-2.5-flash.md"]
        result_notebook_report_27_12_2025_15_26_34_NotebookLLM_gemini_2_5_flash_md["notebook_report_27_12_2025_15-26-34_NotebookLLM_gemini-2.5-flash.md"]
        result_notebook_report_27_12_2025_15_33_06_NotebookLLM_gemini_2_5_flash_md["notebook_report_27_12_2025_15-33-06_NotebookLLM_gemini-2.5-flash.md"]
        result_notebook_report_29_12_2025_15_03_21_NotebookLLM_gemini_2_5_flash_md["notebook_report_29_12_2025_15-03-21_NotebookLLM_gemini-2.5-flash.md"]
        result_report_01_12_2025_12_26_46_Helper_gemini_flash_latest_MainLLM_gemini_2_5_pro_md["report_01_12_2025_12-26-46_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md"]
        result_report_01_12_2025_12_55_01_Helper_gemini_flash_latest_MainLLM_gemini_2_5_pro_md["report_01_12_2025_12-55-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md"]
        result_report_01_12_2025_13_37_30_Helper_gemini_flash_latest_MainLLM_gemini_2_5_pro_md["report_01_12_2025_13-37-30_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md"]
        result_report_01_12_2025_14_15_04_Helper_gemini_2_5_flash_lite_MainLLM_gemini_2_5_pro_md["report_01_12_2025_14-15-04_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md"]
        result_report_01_12_2025_14_42_38_Helper_gemini_2_5_flash_lite_MainLLM_gemini_2_5_pro_md["report_01_12_2025_14-42-38_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md"]
        result_report_01_12_2025_15_27_23_Helper_gemini_2_5_flash_lite_MainLLM_gemini_2_5_pro_md["report_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md"]
        result_report_02_12_2025_15_41_27_Helper_gemini_2_5_flash_MainLLM_gemini_2_5_pro_md["report_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.md"]
        result_report_03_12_2025_22_46_01_Helper_gemini_flash_latest_MainLLM_gemini_2_5_pro_md["report_03_12_2025_22-46-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md"]
        result_report_03_12_2025_23_13_20_Helper_gemini_flash_latest_MainLLM_gemini_2_5_pro_md["report_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md"]
        result_report_05_12_2025_11_07_10_Helper_alias_ha_MainLLM_gemini_2_5_pro_md["report_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.md"]
        result_report_09_12_2025_14_07_49_Helper_alias_code_MainLLM_alias_ha_md["report_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.md"]
        result_report_14_11_2025_14_52_36_md["report_14_11_2025_14-52-36.md"]
        result_report_14_11_2025_15_21_53_md["report_14_11_2025_15-21-53.md"]
        result_report_14_11_2025_15_26_24_md["report_14_11_2025_15-26-24.md"]
        result_report_21_11_2025_15_43_30_md["report_21_11_2025_15-43-30.md"]
        result_report_21_11_2025_16_06_12_md["report_21_11_2025_16-06-12.md"]
        result_report_22_11_2025_14_01_50_Helper_llama3_Main_geminipro_md["report_22_11_2025_14-01-50_Helper_llama3_Main_geminipro.md"]
        result_report_22_11_2025_14_39_55_Helper_llama3_MainLLM_llama3_md["report_22_11_2025_14-39-55_Helper_llama3_MainLLM_llama3.md"]
        result_result_2025_11_11_12_30_53_md["result_2025-11-11_12-30-53.md"]
        result_result_2025_11_11_12_43_51_md["result_2025-11-11_12-43-51.md"]
        result_result_2025_11_11_12_45_37_md["result_2025-11-11_12-45-37.md"]
        schemas_types_py["types.py"]
        statistics_savings_01_12_2025_15_27_23_Helper_gemini_2_5_flash_lite_MainLLM_gemini_2_5_pro_png["savings_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.png"]
        statistics_savings_02_12_2025_15_41_27_Helper_gemini_2_5_flash_MainLLM_gemini_2_5_pro_png["savings_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.png"]
        statistics_savings_03_12_2025_23_13_20_Helper_gemini_flash_latest_MainLLM_gemini_2_5_pro_png["savings_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.png"]
        statistics_savings_05_12_2025_11_07_10_Helper_alias_ha_MainLLM_gemini_2_5_pro_png["savings_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.png"]
        statistics_savings_09_12_2025_14_07_49_Helper_alias_code_MainLLM_alias_ha_png["savings_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.png"]
        root --> SystemPrompts_dir_node["SystemPrompts<br/>SystemPromptClassHelperLLM.txt<br/>SystemPromptFunctionHelperLLM.txt<br/>SystemPromptHelperLLM.txt<br/>SystemPromptMainLLM.txt<br/>SystemPromptMainLLMToon.txt<br/>SystemPromptNotebookLLM.txt"]
        root --> backend_dir_node["backend<br/>AST_Schema.py<br/>File_Dependency.py<br/>HelperLLM.py<br/>MainLLM.py<br/>__init__.py<br/>basic_info.py<br/>callgraph.py<br/>converter.py<br/>getRepo.py<br/>main.py<br/>relationship_analyzer.py<br/>scads_key_test.py"]
        root --> database_dir_node["database<br/>db.py"]
        root --> frontend_dir_node["frontend<br/>__init__.py<br/>frontend.py"]
        root --> notizen_dir_node["notizen<br/>Report Agenda.txt<br/>Zwischenpraesentation Agenda.txt<br/>doc_bestandteile.md<br/>notizen.md<br/>paul_notizen.md<br/>praesentation_notizen.md<br/>technische_notizen.md"]
        root --> result_dir_node["result<br/>ast_schema_01_12_2025_11-49-24.json<br/>notebook_report_23_12_2025_12-56-24_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-06-09_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-09-29_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-26-34_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-33-06_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_29_12_2025_15-03-21_NotebookLLM_gemini-2.5-flash.md<br/>report_01_12_2025_12-26-46_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_12-55-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_13-37-30_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-15-04_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-42-38_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_22-46-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.md<br/>report_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.md<br/>report_14_11_2025_14-52-36.md<br/>report_14_11_2025_15-21-53.md<br/>report_14_11_2025_15-26-24.md<br/>report_21_11_2025_15-43-30.md<br/>report_21_11_2025_16-06-12.md<br/>report_22_11_2025_14-01-50_Helper_llama3_Main_geminipro.md<br/>report_22_11_2025_14-39-55_Helper_llama3_MainLLM_llama3.md<br/>result_2025-11-11_12-30-53.md<br/>result_2025-11-11_12-43-51.md<br/>result_2025-11-11_12-45-37.md"]
        root --> schemas_dir_node["schemas<br/>types.py"]
        root --> statistics_dir_node["statistics<br/>savings_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.png<br/>savings_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.png<br/>savings_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.png<br/>savings_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.png<br/>savings_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.png"]
        root --> _env_example_file[".env.example"]
        root --> _gitignore_file[".gitignore"]
        root --> analysis_output_json_file["analysis_output.json"]
        root --> output_json_file["output.json"]
        root --> output_toon_file["output.toon"]
        root --> readme_md_file["readme.md"]
        root --> requirements_txt_file["requirements.txt"]
        root --> test_json_file["test.json"]
        frontend_dir_node --> frontend_dot_streamlit_dir_node[".streamlit<br/>config.toml"]
        frontend_dir_node --> frontend_gifs_dir_node["gifs<br/>4j.gif"]
        notizen_dir_node --> notizen_grafiken_dir_node["grafiken"]
        notizen_grafiken_dir_node --> notizen_grafiken_1_dir_node["1<br/>File_Dependency_Graph_Repo.dot<br/>global_callgraph.png<br/>global_graph.png<br/>global_graph_2.png<br/>repo.dot"]
        notizen_grafiken_dir_node --> notizen_grafiken_2_dir_node["2<br/>FDG_repo.dot<br/>fdg_graph.png<br/>fdg_graph_2.png<br/>filtered_callgraph_flask.png<br/>filtered_callgraph_repo-agent.png<br/>filtered_callgraph_repo-agent_3.png<br/>filtered_repo_callgraph_flask.dot<br/>filtered_repo_callgraph_repo-agent-3.dot<br/>filtered_repo_callgraph_repo-agent.dot<br/>global_callgraph.png<br/>graph_flask.md<br/>repo.dot"]
        notizen_grafiken_dir_node --> notizen_grafiken_Flask_Repo_dir_node["Flask-Repo<br/>__init__.dot<br/>__main__.dot<br/>app.dot<br/>auth.dot<br/>blog.dot<br/>blueprints.dot<br/>cli.dot<br/>conf.dot<br/>config.dot<br/>conftest.dot<br/>ctx.dot<br/>db.dot<br/>debughelpers.dot<br/>factory.dot<br/>flask.dot<br/>globals.dot<br/>hello.dot<br/>helpers.dot<br/>importerrorapp.dot<br/>logging.dot<br/>make_celery.dot<br/>multiapp.dot<br/>provider.dot<br/>scaffold.dot<br/>sessions.dot<br/>signals.dot<br/>tag.dot<br/>tasks.dot<br/>templating.dot<br/>test_appctx.dot<br/>test_async.dot<br/>test_auth.dot<br/>test_basic.dot<br/>test_blog.dot<br/>test_blueprints.dot<br/>test_cli.dot<br/>test_config.dot<br/>test_config.png<br/>test_converters.dot<br/>test_db.dot<br/>test_factory.dot<br/>test_helpers.dot<br/>test_instance_config.dot<br/>test_js_example.dot<br/>test_json.dot<br/>test_json_tag.dot<br/>test_logging.dot<br/>test_regression.dot<br/>test_reqctx.dot<br/>test_request.dot<br/>test_session_interface.dot<br/>test_signals.dot<br/>test_subclassing.dot<br/>test_templating.dot<br/>test_testing.dot<br/>test_user_error_handler.dot<br/>test_views.dot<br/>testing.dot<br/>typing.dot<br/>typing_app_decorators.dot<br/>typing_error_handler.dot<br/>typing_route.dot<br/>views.dot<br/>wrappers.dot<br/>wsgi.dot"]
        notizen_grafiken_dir_node --> notizen_grafiken_Repo_onboarding_dir_node["Repo-onboarding<br/>AST.dot<br/>Frontend.dot<br/>HelperLLM.dot<br/>HelperLLM.png<br/>MainLLM.dot<br/>agent.dot<br/>basic_info.dot<br/>callgraph.dot<br/>getRepo.dot<br/>graph_AST.png<br/>graph_AST2.png<br/>graph_AST3.png<br/>main.dot<br/>tools.dot<br/>types.dot"]
    ```
...
- zstandard==0.25.0
- nbformat
If `requirements.txt` is present, use: `pip install -r requirements.txt`
### Setup Guide
1.  **Clone the repository**:
    `git clone <repository_url>`
    `cd <repository_name>`
2.  **Set up environment variables**:
    Create a `.env` file in the root directory based on `.env.example` and populate it with your API keys (e.g., for Gemini, OpenAI, Ollama) and database connection strings.
...
*   **Automated Documentation Generation**: Quickly generate comprehensive Markdown documentation for any Python Git repository, detailing its structure, functions, and classes without manual effort.
*   **Developer Onboarding**: New team members can rapidly get up to speed with unfamiliar codebases by exploring LLM-generated reports and interactive analyses.
*   **Code Discovery and Understanding**: Developers can gain deep insights into code logic, inter-component relationships, and usage patterns within a project.
*   **API Key and LLM Management**: Users can securely configure and switch between various Large Language Models (Gemini, OpenAI, Ollama) and their API keys directly through the application's interface.
*   **Interactive Code Q&A**: Engage in chat-based conversations with LLMs about the analyzed codebase to answer specific questions, debug, or understand complex logic.

**Primary Commands:**
- To start the web application: `streamlit run frontend/frontend.py`
- Repository analysis is initiated via the Streamlit UI by providing a GitHub URL.
...
*   **Instantiation:** Based on the provided context, this class is not explicitly instantiated by other components listed.
...
#### Function: `wrap_cdata`
*   **Signature:** `def wrap_cdata(content: Any)`
...
*   **Signature:** `def extract_output_content(outputs: Any, image_list: Any)`
...
*   **Signature:** `def process_image(mime_type: Any)`
...
*   **Signature:** `def convert_notebook_to_xml(file_content: Any)`
...
*   **Signature:** `def process_repo_notebooks(repo_files: Any)`
...
*   **Signature:** `def main_workflow(input: Any, api_keys: dict, model_names: dict, status_callback=None)`
...
*   **Signature:** `def notebook_workflow(input: Any, api_keys: Any, model: Any, status_callback=None)`
...
*   **Signature:** `def gemini_payload(basic_info: Any, nb_path: Any, xml_content: Any, images: Any)`
...
*   **Signature:** `def insert_exchange(question: str, answer: str, feedback: str, username: str, chat_name: str, helper_used: str="", main_used: str="", total_time: str="", helper_time: str="", main_time: str="", json_tokens: Any=0, toon_tokens: Any=0, savings_percent: Any=0.0)`
...
*   **Signature:** `def clean_names(model_list: Any)`
...
*   **Signature:** `def get_filtered_models(source_list: Any, category_name: Any)`
...
*   **Signature:** `def render_text_with_mermaid(markdown_text: Any, should_stream=False)`
...
*   **Instantiation:** The provided context does not specify any explicit locations where this class is instantiated.
*   **Dependencies:** This class does not explicitly list any external functional dependencies in the provided context.
*   **Constructor:**
