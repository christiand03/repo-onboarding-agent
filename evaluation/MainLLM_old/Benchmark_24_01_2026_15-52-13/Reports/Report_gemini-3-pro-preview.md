...
## 1. Project Overview
- **Description:** A comprehensive tool designed to facilitate developer onboarding by automatically analyzing Git repositories. It leverages Large Language Models (LLMs) to generate detailed documentation, architectural insights, and code analysis from source code. The system includes a backend for AST parsing and LLM orchestration, a MongoDB database for storage, and a Streamlit-based frontend for user interaction.
- **Key Features:**
  - **Automated Code Analysis:** Parses Python code using AST to extract functions, classes, and dependencies.
  - **LLM-Powered Documentation:** Uses Helper and Main LLMs to generate human-readable explanations for code components.
  - **Repository Visualization:** Generates dependency graphs and call graphs to visualize project structure.
  - **Interactive Frontend:** Provides a Streamlit UI for users to input repository URLs and view generated reports/metrics.
  - **Database Integration:** Stores user data, chat history, and analysis results using MongoDB.
- **Tech Stack:** Python, Streamlit, LangChain, MongoDB, NetworkX, GitPython, Pydantic.
...
*   **Repository Structure:**
    ...
    SystemPrompts --> prompts["SystemPromptClassHelperLLM.txt<br/>SystemPromptFunctionHelperLLM.txt<br/>..."]
    ```
...
3.  Configure environment variables by creating a `.env` file (reference `.env.example`).
...
**Use Cases:**
1.  **Onboarding:** New developers can input a repository URL to generate a comprehensive report, helping them understand the project structure and logic quickly.
2.  **Documentation Generation:** Automatically generate up-to-date documentation for legacy or undocumented projects using the `backend/main.py` pipeline.
3.  **Code Analysis:** Visualize dependencies and call graphs to understand how different modules interact.
4.  **Interactive Querying:** Use the chat interface in the frontend to ask specific questions about the codebase, powered by LLMs.

**Commands:**
*   Start the Frontend UI: `streamlit run frontend/frontend.py`
*   Run Backend Analysis (Standalone): `python backend/main.py`

## 4. Architecture
*No specific Mermaid syntax provided in input JSON.*
...
*   **Methods:**
    *   **`_clean_content`**
        ...
        *   **Usage:** This method does not explicitly call other methods or functions within its source code. / This method is called by _parse_readme, _parse_toml, and _parse_requirements.
    *   **`_finde_datei`**
        ...
        *   **Usage:** This method does not explicitly call other methods or functions within its source code. / This method is called by extrahiere_info.
...
*   **Methods:**
    *   **`_recursive_call`**
        ...
        *   **Usage:** This method does not explicitly call other functions or methods. / This method is not explicitly called by other functions or methods.
...
*   **Methods:**
    *   **`blob`**
        ...
        *   **Usage:** This method does not explicitly call other methods or functions listed in the provided context. It accesses `self._tree` and `self.path`. / This method is accessed as a property by `content` and `size`.
    *   **`content`**
    ...
    *   **`__repr__`**
        ...
        *   **Usage:** This method does not explicitly call other methods or functions listed in the provided context. / This method is not explicitly called by other methods or functions listed in the provided context. It is implicitly called by Python's `repr()` function or when the object is printed.
    *   **`to_dict`**
...
*   **Methods:**
    ...
    *   **`__enter__`**
        ...
        *   **Usage:** This method does not explicitly call any other functions or methods. / This method is implicitly called by Python when the GitRepository object is used in a with statement.
    *   **`__exit__`**
...
*   **Methods:**
    ...
    *   **`get_raw_relationships`**
        ...
        *   **Usage:** This method does not explicitly call other methods or functions within the class. / This method is not explicitly called by other methods in the provided context.
    *   **`_find_py_files`**
...
*   **Methods:**
    *   **`visit_ClassDef`**
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.ClassDef`): The AST node representing a class definition.
        *   *Returns:*
        *   **Usage:** This method does not explicitly call other methods or functions based on the provided context. / This method is not explicitly called by any known components based on the provided context.
    *   **`visit_FunctionDef`**
        *   *Signature:* `def visit_FunctionDef(self, node: ast.FunctionDef)`
