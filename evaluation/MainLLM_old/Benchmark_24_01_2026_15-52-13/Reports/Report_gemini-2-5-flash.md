...
*   **Description:** This project, the 'Repo Onboarding Agent', is an automated documentation pipeline designed to analyze Git repositories and generate comprehensive technical documentation using Large Language Models (LLMs). It processes repository files, constructs Abstract Syntax Tree (AST) schemas, and analyzes code relationships (functions, classes, calls, dependencies) to produce detailed reports. The agent supports various LLMs (Gemini, OpenAI, Ollama) and includes a Streamlit-based frontend for user interaction.
*   **Key Features:**
    - Automated Repository Cloning & Analysis
    - Abstract Syntax Tree (AST) Schema Generation
    - LLM-Powered Code Documentation (Functions & Classes)
    - Inter-component Relationship Analysis (Call Graphs, Dependencies)
    - Streamlit Web Interface for User Interaction
*   **Tech Stack:** Python, Streamlit, LangChain, Google Generative AI, Ollama, OpenAI, GitPython, NetworkX, PyMongo, Matplotlib, nbformat.

*   **Repository Structure:**
    ```mermaid
    graph LR
    ProjectRoot["Repo Onboarding Agent 🚀"]
    ProjectRoot --> ProjectRoot_files
    ProjectRoot --> SystemPrompts_SystemPrompts
    ProjectRoot --> backend_backend
    ProjectRoot --> database_database
    ProjectRoot --> frontend_frontend
    ProjectRoot --> notizen_notizen
    ProjectRoot --> result_result
    ProjectRoot --> schemas_schemas
    ProjectRoot --> statistics_statistics
    ProjectRoot_files["output.json<br/>output.toon<br/>readme.md<br/>requirements.txt<br/>test.json<br/>.env.example<br/>.gitignore<br/>analysis_output.json"]
    SystemPrompts_SystemPrompts("SystemPrompts")
    SystemPrompts_SystemPrompts --> SystemPrompts_SystemPrompts_files
    SystemPrompts_SystemPrompts_files["SystemPromptClassHelperLLM.txt<br/>SystemPromptFunctionHelperLLM.txt<br/>SystemPromptHelperLLM.txt<br/>SystemPromptMainLLM.txt<br/>SystemPromptMainLLMToon.txt<br/>SystemPromptNotebookLLM.txt"]
    backend_AST_Schema_py_files["AST_Schema.py"]
    backend_File_Dependency_py_files["File_Dependency.py"]
    backend_HelperLLM_py_files["HelperLLM.py"]
    backend_MainLLM_py_files["MainLLM.py"]
    backend_backend("backend")
    backend_backend --> backend_AST_Schema_py_files
    backend_backend --> backend_File_Dependency_py_files
    backend_backend --> backend_HelperLLM_py_files
    backend_backend --> backend_MainLLM_py_files
    backend_backend --> backend___init___py_files
    backend_backend --> backend_basic_info_py_files
    backend_backend --> backend_callgraph_py_files
    backend_backend --> backend_converter_py_files
    backend_backend --> backend_getRepo_py_files
    backend_backend --> backend_main_py_files
    backend_backend --> backend_relationship_analyzer_py_files
    backend_backend --> backend_scads_key_test_py_files
    backend_backend --> schemas_types_py_files
    backend___init___py_files["__init__.py"]
    backend_basic_info_py_files["basic_info.py"]
    backend_callgraph_py_files["callgraph.py"]
    backend_converter_py_files["converter.py"]
    backend_getRepo_py_files["getRepo.py"]
    backend_main_py_files["main.py"]
    backend_relationship_analyzer_py_files["relationship_analyzer.py"]
    backend_scads_key_test_py_files["scads_key_test.py"]
    database_database("database")
    database_database --> database_db_py_files
    database_db_py_files["db.py"]
    frontend__streamlit_config_toml_files["config.toml"]
    frontend__streamlit__streamlit("frontend/.streamlit")
    frontend__streamlit__streamlit --> frontend__streamlit_config_toml_files
    frontend_frontend("frontend")
    frontend_frontend --> frontend__streamlit__streamlit
    frontend_frontend --> frontend___init___py_files
    frontend_frontend --> frontend_frontend_py_files
    frontend_frontend --> frontend_gifs_gifs
    frontend_frontend_py_files["frontend.py"]
    frontend_gifs_gifs("frontend/gifs")
    frontend_gifs_gifs --> frontend_gifs_gifs_files
    frontend_gifs_gifs_files["4j.gif"]
    frontend___init___py_files["__init__.py"]
    notizen_grafiken_1_1("notizen/grafiken/1")
    notizen_grafiken_1_1 --> notizen_grafiken_1_1_files
    notizen_grafiken_1_1_files["File_Dependency_Graph_Repo.dot<br/>global_callgraph.png<br/>global_graph.png<br/>global_graph_2.png<br/>repo.dot"]
    notizen_grafiken_2_2("notizen/grafiken/2")
    notizen_grafiken_2_2 --> notizen_grafiken_2_2_files
    notizen_grafiken_2_2_files["FDG_repo.dot<br/>fdg_graph.png<br/>fdg_graph_2.png<br/>filtered_callgraph_flask.png<br/>filtered_callgraph_repo-agent.png<br/>filtered_callgraph_repo-agent_3.png<br/>filtered_repo_callgraph_flask.dot<br/>filtered_repo_callgraph_repo-agent-3.dot<br/>filtered_repo_callgraph_repo-agent.dot<br/>global_callgraph.png<br/>graph_flask.md<br/>repo.dot"]
    notizen_grafiken_Flask_Repo_Flask_Repo("notizen/grafiken/Flask-Repo")
    notizen_grafiken_Flask_Repo_Flask_Repo --> notizen_grafiken_Flask_Repo_Flask_Repo_files
    notizen_grafiken_Flask_Repo_Flask_Repo_files["__init__.dot<br/>__main__.dot<br/>app.dot<br/>auth.dot<br/>blog.dot<br/>blueprints.dot<br/>cli.dot<br/>conf.dot<br/>config.dot<br/>conftest.dot<br/>ctx.dot<br/>db.dot<br/>debughelpers.dot<br/>factory.dot<br/>flask.dot<br/>globals.dot<br/>hello.dot<br/>helpers.dot<br/>importerrorapp.dot<br/>logging.dot<br/>make_celery.dot<br/>multiapp.dot<br/>provider.dot<br/>scaffold.dot<br/>sessions.dot<br/>signals.dot<br/>tag.dot<br/>tasks.dot<br/>templating.dot<br/>test_appctx.dot<br/>test_async.dot<br/>test_auth.dot<br/>test_basic.dot<br/>test_blog.dot<br/>test_blueprints.dot<br/>test_cli.dot<br/>test_config.dot<br/>test_config.png<br/>test_converters.dot<br/>test_db.dot<br/>test_factory.dot<br/>test_helpers.dot<br/>test_instance_config.dot<br/>test_js_example.dot<br/>test_json.dot<br/>test_json_tag.dot<br/>test_logging.dot<br/>test_regression.dot<br/>test_reqctx.dot<br/>test_request.dot<br/>test_session_interface.dot<br/>test_signals.dot<br/>test_subclassing.dot<br/>test_templating.dot<br/>test_testing.dot<br/>test_user_error_handler.dot<br/>test_views.dot<br/>testing.dot<br/>typing.dot<br/>typing_app_decorators.dot<br/>typing_error_handler.dot<br/>typing_route.dot<br/>views.dot<br/>wrappers.dot<br/>wsgi.dot"]
    notizen_grafiken_Repo_onboarding_Repo_onboarding("notizen/grafiken/Repo-onboarding")
    notizen_grafiken_Repo_onboarding_Repo_onboarding --> notizen_grafiken_Repo_onboarding_Repo_onboarding_files
    notizen_grafiken_Repo_onboarding_Repo_onboarding_files["AST.dot<br/>Frontend.dot<br/>HelperLLM.dot<br/>HelperLLM.png<br/>MainLLM.dot<br/>agent.dot<br/>basic_info.dot<br/>callgraph.dot<br/>getRepo.dot<br/>graph_AST.png<br/>graph_AST2.png<br/>graph_AST3.png<br/>main.dot<br/>tools.dot<br/>types.dot"]
    notizen_grafiken_grafiken("notizen/grafiken")
    notizen_grafiken_grafiken --> notizen_grafiken_1_1
    notizen_grafiken_grafiken --> notizen_grafiken_2_2
    notizen_grafiken_grafiken --> notizen_grafiken_Flask_Repo_Flask_Repo
    notizen_grafiken_grafiken --> notizen_grafiken_Repo_onboarding_Repo_onboarding
    notizen_notizen("notizen")
    notizen_notizen --> notizen_grafiken_grafiken
    notizen_notizen --> notizen_notizen_files
    notizen_notizen_files["Report Agenda.txt<br/>Zwischenpraesentation Agenda.txt<br/>doc_bestandteile.md<br/>notizen.md<br/>paul_notizen.md<br/>praesentation_notizen.md<br/>technische_notizen.md"]
    result_result("result")
    result_result --> result_result_files
    result_result_files["ast_schema_01_12_2025_11-49-24.json<br/>notebook_report_23_12_2025_12-56-24_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-06-09_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-09-29_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-26-34_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_27_12_2025_15-33-06_NotebookLLM_gemini-2.5-flash.md<br/>notebook_report_29_12_2025_15-03-21_NotebookLLM_gemini-2.5-flash.md<br/>report_01_12_2025_12-26-46_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_12-55-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_13-37-30_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-15-04_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_14-42-38_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.md<br/>report_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_22-46-01_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.md<br/>report_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.md<br/>report_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.md<br/>report_14_11_2025_14-52-36.md<br/>report_14_11_2025_15-21-53.md<br/>report_14_11_2025_15-26-24.md<br/>report_21_11_2025_15-43-30.md<br/>report_21_11_2025_16-06-12.md<br/>report_22_11_2025_14-01-50_Helper_llama3_Main_geminipro.md<br/>report_22_11_2025_14-39-55_Helper_llama3_MainLLM_llama3.md<br/>result_2025-11-11_12-30-53.md<br/>result_2025-11-11_12-43-51.md<br/>result_2025-11-11_12-45-37.md"]
    schemas_schemas("schemas")
    schemas_schemas --> schemas_types_py_files
    schemas_types_py_files["types.py"]
    statistics_statistics("statistics")
    statistics_statistics --> statistics_statistics_files
    statistics_statistics_files["savings_01_12_2025_15-27-23_Helper_gemini-2.5-flash-lite_MainLLM_gemini-2.5-pro.png<br/>savings_02_12_2025_15-41-27_Helper_gemini-2.5-flash_MainLLM_gemini-2.5-pro.png<br/>savings_03_12_2025_23-13-20_Helper_gemini-flash-latest_MainLLM_gemini-2.5-pro.png<br/>savings_05_12_2025_11-07-10_Helper_alias-ha_MainLLM_gemini-2.5-pro.png<br/>savings_09_12_2025_14-07-49_Helper_alias-code_MainLLM_alias-ha.png"]
    ```
...
1.  **Clone the repository:**
    ...
    cd "Repo Onboarding Agent 🚀" # Or the actual repository folder name
    ```
2.  **Install dependencies:**
    ```bash
    pip install -r requirements.txt
    ```
3.  **Environment Variables:** Create a `.env` file in the project root, based on the provided `.env.example`, and fill in the necessary API keys for LLM services you intend to use (e.g., Gemini, OpenAI, Ollama base URL if self-hosting).

### Quick Startup
Once set up, you can run the Streamlit frontend application to interact with the Repo Onboarding Agent:
```bash
streamlit run frontend/frontend.py
```
This command will launch the web interface in your browser, allowing you to submit repository URLs for documentation generation.

## 3. Use Cases & Commands

The Repo Onboarding Agent is designed to streamline the process of understanding and documenting new or unfamiliar codebases. Its primary use cases revolve around automated code analysis and LLM-driven report generation, reducing manual effort and accelerating developer onboarding. It can process Python projects, including those with Jupyter notebooks, and generate structured documentation that details architecture, code structure, and relationships between components.
...
*   **Start the Web Interface:**
    ...
    streamlit run frontend/frontend.py
    ```
    This command initiates the interactive Streamlit application, providing a user-friendly interface to input repository URLs, configure LLM models, and view generated documentation.
...
*   **Instantiation:** The class ASTVisitor does not explicitly list any instantiation points in the provided context.
*   **Dependencies:** The class ASTVisitor does not explicitly list any external dependencies in the provided context.
*   **Constructor:**
...
*   **Methods:**
    *   **`visit_Import`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls `self.generic_visit` to continue AST traversal. This method is implicitly called by the `ast.NodeVisitor` traversal mechanism when an `ast.Import` node is encountered.
    *   **`visit_ImportFrom`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls `self.generic_visit` to continue AST traversal. This method is implicitly called by the `ast.NodeVisitor` traversal mechanism when an `ast.ImportFrom` node is encountered.
    *   **`visit_ClassDef`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls `ast.get_docstring` and `ast.get_source_segment` to extract information, and `self.generic_visit` to continue AST traversal. This method is implicitly called by the `ast.NodeVisitor` traversal mechanism when an `ast.ClassDef` node is encountered.
    *   **`visit_FunctionDef`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls `ast.get_docstring` and `ast.get_source_segment` to extract information, and `self.generic_visit` to continue AST traversal. This method is implicitly called by the `ast.NodeVisitor` traversal mechanism when an `ast.FunctionDef` node is encountered.
    *   **`visit_AsyncFunctionDef`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls `self.visit_FunctionDef` to process the async function. This method is implicitly called by the `ast.NodeVisitor` traversal mechanism when an `ast.AsyncFunctionDef` node is encountered.
...
*   **Methods:**
    *   **`merge_relationship_data`**
        ...
        *   **Usage:** This method primarily uses dictionary 'get' methods and list/set operations. This method is not explicitly called by any other functions or methods listed in the method_context for this method.
    *   **`analyze_repository`**
        ...
        *   **Usage:** This method calls 'os.path.commonpath', 'os.path.isfile', 'os.path.dirname', 'ast.parse', 'ASTVisitor' (instantiation), 'visitor.visit', and accesses 'visitor.schema'. This method is not explicitly called by any other functions or methods listed in the method_context for this method.
...
*   **Instantiation:** This class does not explicitly list any instantiation points in the provided context.
...
*   **Methods:**
    *   **`_resolve_module_name`**
        ...
        *   **Usage:** This method does not explicitly call other functions or methods based on the provided context. This method is not explicitly called by other functions or methods based on the provided context.
    *   **`visit_Import`**
...
*   **Methods:**
    *   **`_configure_batch_settings`**
        ...
        *   *Returns:*
        *   **Usage:** No specific calls were identified from the provided context. No specific callers were identified from the provided context.
...
*   **Methods:**
    *   **`_clean_content`**
        ...
        *   **Usage:** This method calls no other methods or functions within its source code. This method is called by _parse_readme, _parse_toml, and _parse_requirements.
    *   **`_finde_datei`**
        ...
        *   **Usage:** This method calls no other methods or functions within its source code. This method is called by extrahiere_info.
    *   **`_extrahiere_sektion_aus_markdown`**
        ...
        *   **Usage:** This method calls re.escape, re.compile, re.IGNORECASE, re.DOTALL, pattern.search, match.group, and strip. This method is called by _parse_readme.
    *   **`_parse_readme`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls self._clean_content, re.search, self._extrahiere_sektion_aus_markdown, strip, and split. This method is called by extrahiere_info.
    *   **`_parse_toml`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls self._clean_content, tomllib.loads, data.get, and print. This method is called by extrahiere_info.
    *   **`_parse_requirements`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls self._clean_content, splitlines, strip, and startswith. This method is called by extrahiere_info.
    *   **`extrahiere_info`**
        ...
        *   **Usage:** This method calls self._finde_datei, self._parse_toml, self._parse_requirements, self._parse_readme, isinstance, os.path.basename, and removesuffix. This method is not explicitly called by other methods or functions within the provided context.
...
*   **Instantiation:** This class is not explicitly instantiated by other components.
...
*   **Methods:**
    *   **`_recursive_call`**
        ...
        *   **Usage:** This method calls no other functions or methods. This method is not explicitly called by other functions or methods.
...
*   **Signature:** `def extract_output_content(outputs: list[object], image_list: list[dict])`
...
*   **Methods:**
    *   **`blob`**
        ...
        *   **Usage:** This method calls no other methods or functions listed in the provided context. It accesses `self._tree` and `self.path`. This method is accessed as a property by `content` and `size`.
    *   **`content`**
        ...
        *   **Usage:** This method implicitly calls the `blob` property to retrieve the Git blob object. This method is accessed as a property by `analyze_word_count` and `to_dict`.
    *   **`size`**
        *   *Signature:* `def size()`
        ...
        *   **Usage:** This method implicitly calls the `blob` property to retrieve the Git blob object. This method is accessed as a property by `to_dict`.
    *   **`analyze_word_count`**
        ...
        *   **Usage:** This method implicitly calls the `content` property. This method is not explicitly called by other methods or functions listed in the provided context.
    *   **`__repr__`**
        ...
        *   **Usage:** This method calls no other methods or functions listed in the provided context. This method is not explicitly called by other methods or functions listed in the provided context. It is implicitly called by Python's `repr()` function or when the object is printed.
    *   **`to_dict`**
        *   *Signature:* `def to_dict(include_content: bool = False)`
        ...
        *   **Usage:** This method implicitly calls the `size` and `content` properties, and `os.path.basename`. This method is not explicitly called by other methods or functions listed in the provided context.
...
*   **Methods:**
    *   **`get_all_files`**
        ...
        *   **Usage:** This method calls self.repo.git.ls_files() to list files and RepoFile to create file objects. This method is called by get_file_tree.
    *   **`close`**
        *   *Signature:* `def close()`
        ...
        *   *Parameters:*
            - **self** (`GitRepository`): The instance of the GitRepository class.
        *   *Returns:*
        *   **Usage:** This method calls print(). This method is called by __exit__ and within the __init__ method's error handling.
    *   **`__enter__`**
        ...
        *   **Usage:** This method calls no other functions or methods. This method is implicitly called by Python when the GitRepository object is used in a with statement.
    *   **`__exit__`**
        *   *Signature:* `def __exit__(exc_type, exc_val, exc_tb)`
        ...
        *   *Returns:*
        *   **Usage:** This method calls self.close(). This method is implicitly called by Python when exiting a with statement block that uses a GitRepository object.
    *   **`get_file_tree`**
        *   *Signature:* `def get_file_tree(include_content: bool = False)`
        ...
        *   **Usage:** This method calls self.get_all_files() and file_obj.to_dict(). This method is not explicitly called by other methods in the provided method_context.
...
*   **Signature:** `def calculate_net_time(start_time: datetime.datetime, end_time: datetime.datetime, total_items: int, batch_size: int, model_name: str)`
...
*   **Signature:** `def main_workflow(input: str, api_keys: dict, model_names: dict, status_callback: callable | None = None)`
...
*   **Signature:** `def notebook_workflow(input: str, api_keys: dict, model: str, status_callback: callable | None = None)`
...
*   **Methods:**
    *   **`analyze`**
        ...
        *   **Usage:** This method calls _find_py_files to get Python files, _collect_definitions to gather definitions, and _resolve_calls to establish call relationships. This method is not explicitly called by other methods in the provided context.
    *   **`get_raw_relationships`**
        ...
        *   **Usage:** This method calls no other methods or functions within the class. This method is not explicitly called by other methods in the provided context.
    *   **`_find_py_files`**
        ...
        *   **Usage:** This method calls os.walk to traverse directories and os.path.join to construct file paths. This method is called by analyze.
    *   **`_collect_definitions`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls open, f.read, ast.parse, path_to_module, ast.walk, _get_parent, and logging.error. This method is called by analyze.
    *   **`_get_parent`**
        *   *Signature:* `def _get_parent(tree, node)`
        ...
        *   **Usage:** This method calls ast.walk to traverse the tree and ast.iter_child_nodes to get children of a node. This method is called by _collect_definitions.
    *   **`_resolve_calls`**
        ...
        *   *Returns:*
        *   **Usage:** This method calls CallResolverVisitor to create a visitor, resolver.visit to traverse the AST, resolver.calls to get identified calls, and logging.error for error reporting. This method is called by analyze.
...
*   **Methods:**
    *   **`visit_ClassDef`**
        ...
        *   *Parameters:*
            ...
            - **node** (`ast.ClassDef`): The AST node representing a class definition.
        *   *Returns:*
        *   **Usage:** This method calls no other methods or functions based on the provided context. This method is not explicitly called by any known components based on the provided context.
    *   **`visit_FunctionDef`**
        *   *Signature:* `def visit_FunctionDef(node: ast.FunctionDef)`
...
*   **Description:** This function renames a chat and all its associated exchanges (messages) within the database. It first updates the chat entry in the 'dbchats' collection by changing its 'chat_name' from 'old_name' to 'new_name' for a specific 'username'. Subsequently, it updates all related exchange entries in the 'dbexchanges' collection, also changing their 'chat_name' from 'old_name' to 'new_name' for the same 'username'. The function returns the count of chat entries that were modified in the initial update operation.
*   **Parameters:**
...
*   **Signature:** `def insert_exchange(question: str, answer: str, feedback: str, username: str, chat_name: str, helper_used: str = "", main_used: str = "", total_time: str = "", helper_time: str = "", main_time: str = "", json_tokens: int = 0, toon_tokens: int = 0, savings_percent: float = 0.0)`
