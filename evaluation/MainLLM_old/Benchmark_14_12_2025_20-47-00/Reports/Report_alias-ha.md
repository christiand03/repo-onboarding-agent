...
*   **Summary:** null
*   **Instantiation:** 
      - file:function,mode,line: 
        - HelperLLM_evaluation.py:evaluation,function,128
        - MainLLM_evaluation.py:prepare_shared_input,function,131
        - main.py:main_workflow,function,182
*   **Dependencies:** 
      - 
*   **Constructor:**
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - HelperLLM_evaluation.py:evaluation,function,129
        - MainLLM_evaluation.py:prepare_shared_input,function,132
        - main.py:main_workflow,function,187
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - File_Dependency.py:build_file_dependency_graph,function,156
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - HelperLLM.py:main_orchestrator,function,387
        - HelperLLM_evaluation.py:evaluation,function,222
        - MainLLM_evaluation.py:prepare_shared_input,function,214
        - main.py:main_workflow,function,284
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - MainLLM_evaluation.py:benchmark_loop,function,302
        - main.py:main_workflow,function,398
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - HelperLLM_evaluation.py:evaluation,function,104
        - MainLLM_evaluation.py:prepare_shared_input,function,121
        - main.py:main_workflow,function,160
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - callgraph.py:build_filtered_callgraph,function,199
        - callgraph.py:build_filtered_callgraph,function,206
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - getRepo.py:get_all_files,method,111
*   **Dependencies:** 
      - 
...
*   **Instantiation:** 
      - file:function,mode,line: 
        - HelperLLM_evaluation.py:evaluation,function,86
        - MainLLM_evaluation.py:prepare_shared_input,function,116
        - main.py:main_workflow,function,141
*   **Dependencies:** 
      - 
...
*   **Description:** Erstellt ein Balkendiagramm für den Token-Vergleich und speichert es.
*   **Parameters:**
...
*   **Description:** Berechnet die Dauer abzüglich der Sleep-Zeiten für Rate-Limits.
*   **Parameters:**
